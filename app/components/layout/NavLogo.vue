<template>
  ...
  >
    ...
    <div :class="['h-[38px] w-[213px]', tone === 'on-light' ? 'logo-on-light' : '']">
      <BaseImage
...
// Surface behind the logo: the lockup is a single white asset, inverted to
// ink via CSS filter once the header goes solid over the paper background

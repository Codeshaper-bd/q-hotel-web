  ...
  <footer class="bg-paper p-2 sm:p-3 lg:p-4">
    <div class="overflow-hidden rounded-sm bg-night text-paper">
      <BaseContainer size="xl">
        ...
        <div
          class="grid gap-12 py-16 md:grid-cols-2 lg:grid-cols-[1.15fr_0.9fr_1.05fr] lg:gap-x-20 xl:grid-cols-[1.2fr_0.85fr_1.05fr] xl:gap-x-28"
        >
          <!-- Brand -->
          ...
          <div class="flex flex-col lg:pt-1">
            ...
            <form
              class="mt-10 flex w-full items-end gap-4"

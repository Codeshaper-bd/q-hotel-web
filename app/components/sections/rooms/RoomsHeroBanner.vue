<template>
  <!--
    ...
    container grid.
  -->
  <section aria-labelledby="rooms-banner-title" class="relative isolate bg-ink text-paper">
    <div class="relative flex min-h-[26rem] items-center justify-center overflow-hidden py-24 sm:min-h-[28rem]">
      ...
      <div class="relative z-10 flex flex-col items-center gap-4 text-center">
        ...
        <h1 id="rooms-banner-title" class="font-display text-4xl text-paper sm:text-5xl">
          Select Your Room
        </h1>
      </div>
    </div>

  ...
  >
    ...
    >
      <div data-reveal-item>
        <BaseKicker transparent>Terms & Conditions</BaseKicker>
      </div>

      <BaseTitle id="terms-title">
        Terms Designed for a Seamless Stay
      </BaseTitle>
    </FadeReveal>

    <p
      id="terms-document"
      class="text-xs font-medium uppercase tracking-[0.16em] text-ink sm:text-sm mt-[60px]"
    >
      Last Updated: August 2026
    </p>

    <p class="mt-8 text-base text-ink/70">
      Welcome to Q Hotel Dhaka. These Terms & Conditions govern your use of our
      website and the booking, accommodation, dining, event, and other
      hospitality services provided by Q Hotel Dhaka, operated by Quality
      Hospitality Limited.
    </p>

    <p class="mt-4 text-base leading-[1.7] text-ink/70">
      By accessing our website, making a reservation, submitting an enquiry, or
    ...
    <div class="mt-8 space-y-12 sm:mt-9 sm:space-y-14">
      ...
      >
        <h2
          ...
          class="font-display text-2xl font-semibold text-ink sm:text-[28px] "
        >
...
const policySections: PolicySection[] = [
  ...
  },
  {
    ...
    paragraphs: [],
    leadIn:
      "Depending on the selected rate or booking option, guests may be offered:",
    bullets: [
  ...
  },
  {
    ...
    contact: {
      name: "Q Hotel Dhaka",
      address:
        "Plot C-11, Block A, Sector 1, Purbachal Road, Dhaka 1229, Bangladesh",

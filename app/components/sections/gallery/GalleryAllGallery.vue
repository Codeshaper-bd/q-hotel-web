<template>
  ...
  >
    ...
    <FadeReveal>
      <div class="mt-12 flex flex-col items-center gap-12 lg:mt-16">
        <div
...
const galleryImages: GalleryImage[] = [
  {
    src: "/images/gallery/grid-01.jpg",
    alt: "Dark, contemporary suite bedroom at Q Hotel Dhaka",
    category: "rooms",
  },
  {
    src: "/images/gallery/grid-02.jpg",
    alt: "Bedroom with artwork and city-view window at Q Hotel Dhaka",
    category: "rooms",
  },
  {
    src: "/images/gallery/grid-03.jpg",
    alt: "Guest room corridor at Q Hotel Dhaka",
    category: "architecture",
  },
  {
    src: "/images/gallery/grid-04.jpg",
    alt: "Banquet hall set for an event at Q Hotel Dhaka",
    category: "meetings",
  },
  {
    src: "/images/gallery/grid-05.jpg",
    alt: "Rooftop bar with skyline view at Q Hotel Dhaka",
    category: "facilities",
  },
  {
  ...
  {
    src: "/images/gallery/grid-06.jpg",
    alt: "Bathroom vanity with backlit mirror at Q Hotel Dhaka",
    category: "rooms",
  },
  {
    src: "/images/gallery/grid-07.jpg",
    alt: "Marble walk-in shower at Q Hotel Dhaka",
    category: "rooms",
  },
  {

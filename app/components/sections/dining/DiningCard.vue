  ...
  <div :id="id" class="scroll-mt-24 bg-[#FDFBF7] py-10 px-10">
    <FadeReveal>
      <div class="flex flex-wrap items-center gap-4 sm:gap-6">
        ...
        >
          ...
          >
            <path
              d="m10 1.5 2.55 5.17 5.7.83-4.13 4.02.98 5.68L10 14.52 4.9 17.2l.98-5.68L1.75 7.5l5.7-.83L10 1.5Z"
            />
          </svg>
          Reservation Recommended
        </span>
      </div>
      <p class="text-sm text-[#A75B27] uppercase">{{ tagline }}</p>
    </FadeReveal>
        ...
        <div class="col-span-2 flex flex-col gap-4 md:col-span-1">
          <FadeReveal direction="up" :distance="24" start="top 92%">
            <div class="h-64 sm:h-80 md:h-[272px] lg:h-[362px]">
              <BaseImage
                :src="topImage"
                :alt="`${name} dining area at Q Hotel Dhaka`"
                :width="800"
                :height="600"
                sizes="xs:100vw sm:100vw lg:50vw"
              />
          ...
          <FadeReveal direction="up" :distance="24" start="top 92%">
            <div class="h-64 sm:h-80 md:h-[272px] lg:h-[362px]">
              <BaseImage
                :src="bottomImage"
                :alt="`${name} interior at Q Hotel Dhaka`"
                :width="800"
                :height="600"
                sizes="xs:100vw sm:100vw lg:50vw"
              />
    ...
    <FadeReveal direction="up" :distance="28" start="top 92%">
      <div class="mt-4 grid gap-4 md:grid-cols-2">
        <div class="col-span-2 md:col-span-1 bg-[#FCF8F0]">
          <div class="p-5">
        ...
        <div class="col-span-2 md:col-span-1 bg-[#FCF8F0] flex flex-col justify-center">
          <BaseInfoCard
            :items="[
              {
                label: 'Contact',

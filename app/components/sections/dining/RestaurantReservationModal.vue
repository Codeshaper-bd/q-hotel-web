<template>
  <!--
    Restaurant table reservation modal. Built on BaseModal (native <dialog>
  ...
  <BaseModal
    v-model="open"
    labelled-by="reservation-dialog-title"
    close-label="Close reservation dialog"
    @close="emit('close')"
  >
    <div
      data-lenis-prevent-wheel
      class="grid max-h-[92dvh] w-full overflow-y-auto bg-white lg:h-[min(826px,92dvh)] lg:grid-cols-[460px_1fr] lg:overflow-hidden"
    >
        <!-- ========================= -->
        ...
        <aside class="relative flex flex-col overflow-hidden bg-[#F7F0E1]">
          ...
          >
            ...
            <p class="mt-5 text-[13px] text-[#373737] font-medium sm:text-base">
              Fill in the details below, and we'll prepare everything for your
            ...
            >
              ...
              <span>
                ...
                <span
                  class="mt-1 block text-[13px] text-[#0F0F10] sm:text-base"
                >
                  Call us at
            ...
            <div class="space-y-5">
              ...
              <div class="flex items-start gap-2">
                ...
                <p class="text-base text-[#505155]">
                  ...
                  Your reservation is not confirmed until you receive a
                  confirmation email or phone call from our team.
                </p>
              </div>
            </div>

...
<template>
  ...
  >
    ...
    <EventReservationModal
      ...
      :venue-image="selectedVenue.images.feature.src"
...
const selectedVenue = ref<VenueShowcase>(venues[0]!);

function openReservation(venue: VenueShowcase) {
